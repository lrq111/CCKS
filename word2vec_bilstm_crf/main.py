...
if __name__ == '__main__':
    ...
    if args.mode == 'train':
        ...
        with open('bilstm_crf_model.pkl', 'rb') as file_pi:
            hist = pickle.load(file_pi)
        fig = plt.figure()  # 新建一张图
        plt.plot(hist['crf_viterbi_accuracy'], label='training acc')
        plt.plot(hist['val_crf_viterbi_accuracy'], label='val acc')
        plt.title('model accuracy')
        plt.ylabel('accuracy')
        plt.xlabel('epoch')
        plt.legend(loc='lower right')
        fig.savefig('bilstm_crf' + 'acc.png')
        fig = plt.figure()
        ...
        fig.savefig('bilstm_crf' + 'loss.png')